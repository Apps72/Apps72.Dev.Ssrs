...
namespace Apps72.Dev.Ssrs.ReportViewer.SampleUI
{
    ...
    /// at HKEY_CURRENT_USER\Software\Apps72\ or defined by the Root property
    /// </summary>
    public class Registry : IDisposable
    {
        #region DECLARATION 

        private const string _defaultRoot = @"Software\Apps72\";
        private const string _defaultApp = "SsrsReportViewer";
        private const string _defaultSection = "";
        ...
        /// </summary>
        public Registry() : this(_defaultRoot, _defaultApp, _defaultSection)
        {
        }
        ...
        public Registry(string application, string section) : this(_defaultRoot, application, section)
        {
        }
        ...
        /// Initialize a new instance of registry
        /// </summary>
        /// <param name="root">Root name (ex. Software\Apps72)</param>
        /// <param name="application">Software name</param>
        /// <param name="section">Configuration section name</param>
        ...
        /// <summary>
        /// Gets the key value associated to 'HKCU\Software\Apps72\SsrsReportViewer\<see cref="Section"/>'
        /// </summary>
        /// <param name="section"></param>
        /// <param name="key"></param>
        /// <returns></returns>
        public static string GetStaticValue(string section, string key)
        {
            using (Registry registry = new Registry(_defaultApp, section))
            {
        ...
        /// <summary>
        /// Sets the key value associated to 'HKCU\Software\Apps72\SsrsReportViewer\<see cref="Section"/>'
        /// </summary>
        /// <param name="section"></param>
        /// <param name="key"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        public static void SetStaticValue(string section, string key, string value)
        {
            using (Registry registry = new Registry(_defaultApp, section))
            {
        ...
        /// <summary>
        /// Gets the key value as a bool (default false) associated to 'HKCU\Software\Apps72\SsrsReportViewer\<see cref="Section"/>'
        /// </summary>
        /// <param name="section"></param>
        /// <param name="key"></param>
        /// <returns></returns>
        public static bool GetStaticBooleanValue(string section, string key)
        {
            using (Registry registry = new Registry(_defaultApp, section))
            {
                string boolString = registry.GetValue(key);
